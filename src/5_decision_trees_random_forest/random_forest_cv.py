...
# Random Forest Classifier. Grid search for n_estimators, max_depth, and max_features
...
disp.ax_.set_title("RF Magic Gamma Telescope Confusion matrix")
plt.savefig("src/5_decision_trees_random_forest/imgs/rf_cm.png")
